...
import (
	...
	_ "github.com/SENERGY-Platform/budget/docs"
...
func DocEndpoint(router *gin.Engine, config configuration.Config, control *controller.Controller) {
...
func swaggerDocHandler(c *gin.Context) {
	...
	if err != nil {
		_ = c.Error(errors.Join(err, models.ErrInternalServerError))
		return
	}
